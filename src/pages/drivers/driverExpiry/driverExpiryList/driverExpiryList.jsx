...
function DriverExpiryList() {
      ...
      // },
      {
        ...
        cell: ({ row }) => (
          <div className="w-full flex justify-start items-center gap-2">
            ...
            >
              <KeenIcon icon="pencil" className="group-hover:text-red-600" />
            </button>
            {/* <button
							className='rounded-full px-2 py-2  w-8 h-8 flex justify-center items-center hover:bg-red-100 group'
							onClick={() => {
  ...
  return (
    <Fragment>
      ...
      {editDriverModal && (
        <UpdateDriverExpiry open={editDriverModal} onOpenChange={handleClose} />
      )}
      {addDriverModal && (
        <AddDriverExpiry open={addDriverModal} onOpenChange={handleClose} />
      )}
      {/* {deleteDriverModal && (
				<DeleteDriver
